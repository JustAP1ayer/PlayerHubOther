        ...
        local Button = Section.Component("Button","Use Mousescroll to go through pages",function()
            ...
            local Button = Section.Component("Button","Support us - Cashapp - $JustAPlayer",function()
                ...
                local Button = Section.Component("Button","Automob is a bit buggy but idgaf",function()
                    ...
                    Section.Component("Toggle","Cleaner TP (breaks movement)",function(bool)
                        _G.CleanerTween = bool;
                        function cleanertween()
                            if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and _G.CleanerTween == true then
                                local BV = Instance.new('BodyVelocity', game.Workspace)
                                BV.Parent = game.Players.LocalPlayer.Character.HumanoidRootPart
                                BV.velocity = Vector3.new(0, 0, 0)
                                BV.maxForce = Vector3.new(9e9, 9e9, 9e9)
                                BV.Name = "PlayerHubTween"
                                        elseif game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and  game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart"):FindFirstChild("PlayerHubTween") and not _G.CleanerTween == true then
                                game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart"):FindFirstChild("PlayerHubTween"):Destroy()
                            end
                            end
                            cleanertween()
...
local bossxd
    ...
    selectedboss = game:GetService("Workspace").Arenas[value .. "Arena"]
    bossxd = value
                end,false)
                    ...
                    while getgenv().MobFarming do
                        spawn(function()
                            if selectedboss then
                                if selectedboss.Boss:FindFirstChild(arenaBosses[bossxd]) and selectedboss.Boss:FindFirstChild(arenaBosses[bossxd]):FindFirstChild("HumanoidRootPart") then
                                    if game:GetService("Players").LocalPlayer.Character then
                                    local destination = selectedboss.Boss:FindFirstChild(arenaBosses[bossxd]):FindFirstChild("HumanoidRootPart").CFrame * Vector3.new(3.44, 12, 3)
                                    game:GetService("Players").LocalPlayer.Character:MoveTo(destination)
                                end
                            end
                        end
                    end)
