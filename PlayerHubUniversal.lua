...
if game.PlaceId == 301549746 then
        ...
        while _G.AutoTpCT == true do
            ...
            if character and character:FindFirstChild("HumanoidRootPart") then
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(
                    workspace.Map.SpawnPoints["BuyArea2"].Position + Vector3.new(1, 4, 1))
            end
            wait(.5)
    ...
    Section.Component("Toggle", "Auto Teleport T Area", function(bool)
        ...
        while _G.AutoTpT == true do
            ...
            if character and character:FindFirstChild("HumanoidRootPart") then
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(
                    workspace.Map.SpawnPoints["BuyArea"].Position + Vector3.new(1, 4, 1))
            end
            wait(1)
    ...
    Section.Component("Toggle", "Auto Teleport Bomb Site A", function(bool)
        ...
        while _G.AutoTpA == true do
            ...
            if character and character:FindFirstChild("HumanoidRootPart") then
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(
                    workspace.Map.SpawnPoints["C4Plant2"].Position + Vector3.new(1, 4, 1))
            end
            wait(.5)
    ...
    Section.Component("Toggle", "Auto Teleport Bomb Site B", function(bool)
        ...
        while _G.AutoTpB == true do
            ...
            if character and character:FindFirstChild("HumanoidRootPart") then
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(
                    workspace.Map.SpawnPoints["C4Plant"].Position + Vector3.new(1, 4, 1))
            end
            wait(.5)
...
local function autoinvis()
    if _G.DissembleBodyVersion == "Version 1" then
        if game.Players.LocalPlayer.Character and _G.AutoInvisible == true then
            if game.Players.LocalPlayer.Character:FindFirstChild("UpperTorso"):FindFirstChild("Waist") and
                game.Players.LocalPlayer.Character:FindFirstChild("UpperTorso") then
            ...
            if game.Players.LocalPlayer.Character:FindFirstChild("LowerTorso") and
                game.Players.LocalPlayer.Character:FindFirstChild("LowerTorso"):FindFirstChild("Root") then
...
Section.Component("Dropdown", "Dissemble Body Verison", {"Version 1", "Version 2", "Version 3"}, false,
    function(versionfor, bool)
...
Section.Component("Toggle", "Auto Dissemble Body / Invisible", function(bool)
    ...
    game.Players.LocalPlayer.CharacterAdded:Connect(function()
        repeat
            wait()
        until game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("LowerTorso") and
...
local HitPartDropdown = Section.Component("Dropdown", "Target Hit Part",
    {"Head", "UpperTorso", "LowerTorso", "HumanoidRootPart", "RightUpperLeg", "LeftHand", "RightHand", "LeftLowerArm",
     "RightLowerArm", "LeftUpperArm", "RightUpperArm", "LeftFoot", "LeftLowerLeg", "LeftUpperLeg", "RightFoot",
     "RightLowerLeg"}, false, function(hitpart, bool)
        TAimPart = hitpart
...
function GetClosestPlayerToMouse()
    ...
    for i, v in pairs(game.Players:GetPlayers()) do
        pcall(function()
            if v.Character and v.Character.Humanoid and v.Character.Humanoid.Health ~= 0 and
                v.Character.HumanoidRootPart and
                WallCheck(v.Character.HumanoidRootPart.Position, {game.Players.LocalPlayer.Character, v.Character}) and
                v ~= game.Players.LocalPlayer then
                    ...
                    if Prediction then
                        if BackTracing then
                            AimAtTarget(MainTarget.Character[BodyHitbox].Position -
                                            MainTarget.Character[BodyHitbox].Velocity * PredictionAmount)
                        else
                            AimAtTarget(MainTarget.Character[BodyHitbox].Position +
                                            MainTarget.Character[BodyHitbox].Velocity * PredictionAmount)
                        end
