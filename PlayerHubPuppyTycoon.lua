...
for i, v in pairs(workspace.Game.Tycoons:GetChildren()) do
    if v:IsA("Model") and v:FindFirstChild("__Spawn") and v:FindFirstChild("__Spawn"):FindFirstChild("Attachment") and
        v:FindFirstChild("__Spawn"):FindFirstChild("Attachment"):FindFirstChild("OwnerDisplay") and
        v:FindFirstChild("__Spawn"):FindFirstChild("Attachment"):FindFirstChild("OwnerDisplay"):FindFirstChild("Title") and
        v:FindFirstChild("__Spawn"):FindFirstChild("Attachment"):FindFirstChild("OwnerDisplay"):FindFirstChild("Title").Text ==
        tostring(game.Players.LocalPlayer) .. "'s Tycoon" then
        print(v)
        lptycoon = v
    end
end
spawn(function()
    while task.wait(2.5) do
        for i, v in pairs(workspace.Game.Tycoons:GetChildren()) do
            if v:IsA("Model") and v:FindFirstChild("__Spawn") and
                v:FindFirstChild("__Spawn"):FindFirstChild("Attachment") and
                v:FindFirstChild("__Spawn"):FindFirstChild("Attachment"):FindFirstChild("OwnerDisplay") and
                v:FindFirstChild("__Spawn"):FindFirstChild("Attachment"):FindFirstChild("OwnerDisplay")
                    :FindFirstChild("Title") and
                v:FindFirstChild("__Spawn"):FindFirstChild("Attachment"):FindFirstChild("OwnerDisplay")
                    :FindFirstChild("Title").Text == tostring(game.Players.LocalPlayer) .. "'s Tycoon" then
                lptycoon = v
            end
        end
    end
end)
Section.Component("Toggle", "Auto Spin ", function(bool)
    _G.AutoSpins = bool
    while task.wait(0.5) and _G.AutoSpins do
        local args = {
            [1] = "RequestSpin"
        }

        game:GetService("ReplicatedStorage"):WaitForChild("NetworkEvents"):WaitForChild("RemoteFunction"):InvokeServer(
            unpack(args))
...
Section.Component("Toggle", "Auto Collect Free Drops ", function(bool)
    ...
    while task.wait(0.5) and _G.AutoCOllectFreeDroppers do
        if lptycoon:FindFirstChild("FreeDropper") and lptycoon:FindFirstChild("FreeDropper"):FindFirstChild("Trigger") and
            lptycoon:FindFirstChild("FreeDropper"):FindFirstChild("Trigger"):FindFirstChild("TouchInterest") then
            if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("Head") then
                firetouchinterest(game.Players.LocalPlayer.Character.Head,
                    lptycoon:FindFirstChild("FreeDropper"):FindFirstChild("Trigger"), 0)
            end
        end
    end
end, false)
...
Section.Component("Toggle", "Auto Deposit Drops ", function(bool)
    ...
    while _G.AutoDepDrops and task.wait(autodepspeed) do
        ...
        game:GetService("ReplicatedStorage"):WaitForChild("NetworkEvents"):WaitForChild("RemoteEvent"):FireServer(
            unpack(args))
    end
end, false)
...
local ticksperms = 3
Section.Component("Slider2", "ticks per ms (High = Laggy asf)", 1, 30, false, function(value)
    ticksperms = value
end, ticksperms)
Section.Component("Toggle", "Op Asf Autofarm", function(bool)
    _G.AutoFarmOP = bool
    while _G.AutoFarmOP and task.wait() do
        task.spawn(function()
            for i = 1, tonumber(ticksperms) do
                task.spawn(function()
                    ...
                    game:GetService("ReplicatedStorage"):WaitForChild("NetworkEvents"):WaitForChild("RemoteEvent")
