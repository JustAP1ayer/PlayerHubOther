             ...
             Section.Component("Button","Support us - Cashapp - $JustAPlayer",function()
                -- Code
                        ...
                        Section.Component("Button", "Webhooks", function()
                                        ...
                                        request({
                                            ...
                                            Body = httpService:JSONEncode({
                                                ...
                                                embeds = {{
                                                    ...
                                                    game:GetService("Players").LocalPlayer.leaderstats["\240\159\140\137Bridges"].Value .. " Bridges",
                                                    color = 0x81ff57,
                                                    fields = {{
                            ...
                            b:Toggle("^ Enable Rebirth Webhook ^", function(bool)
                                ...
                                coroutine.wrap(function()
                                    local httpService = game:GetService("HttpService")
                                    local request = (syn and syn.request) or request or (http and http.request) or http_request
                                    local LastRebirthAmount = game:GetService("Players").LocalPlayer.leaderstats["\240\159\145\145Rebirths"].Value
                                        ...
                                        request({
                                            ...
                                            Body = httpService:JSONEncode({
                                                ...
                                                embeds = {{
                                                    ...
                                                    game:GetService("Players").LocalPlayer.leaderstats["\240\159\145\145Rebirths"].Value .. " Rebirth",
                                                    color = 0x81ff57,
                                                    fields = {{
                    ...
                    Section.Component("Toggle","Auto Farm Races",function(bool)
                        ...
                        while task.wait() and _G.AutofarmRace == true do
                            for i = 1, 5 do
                                task.spawn(function()
                    local args = {
                        [1] = "Start"
                    ...
                    game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("kumarion_knit-rojo@0.2.0"):WaitForChild("knit-rojo"):WaitForChild("Services"):WaitForChild("BridgeService"):WaitForChild("RF"):WaitForChild("Action"):InvokeServer(unpack(args))
                    local args = {
                        [1] = "Finish"
                    }
                    ...
                    game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("kumarion_knit-rojo@0.2.0"):WaitForChild("knit-rojo"):WaitForChild("Services"):WaitForChild("BridgeService"):WaitForChild("RF"):WaitForChild("Action"):InvokeServer(unpack(args))
                                        ...
                                        Section.Component("Toggle","Auto Buy Bridge Upgrade",function(bool)
                                            _G.AutoBridge = bool
while task.wait(0.25) and _G.AutoBridge == true do
    for i = 1, 5 do
    ...
    game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("kumarion_knit-rojo@0.2.0"):WaitForChild("knit-rojo"):WaitForChild("Services"):WaitForChild("BridgeService"):WaitForChild("RF"):WaitForChild("Purchase"):InvokeServer(unpack(args))
end 
end
                                                            end,false) 
                                                            Section.Component("Toggle","Auto Claim Lucky Block",function(bool)
                                                                _G.AutoClaimLuck = bool
                    while task.wait(3) and _G.AutoClaimLuck == true do
                        for i = 1, 5 do
                            game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("kumarion_knit-rojo@0.2.0"):WaitForChild("knit-rojo"):WaitForChild("Services"):WaitForChild("LuckyBlockService"):WaitForChild("RF"):WaitForChild("Claim"):InvokeServer()
                    end 
                    end
                                                                                end,false)     
                    ...
                    while task.wait(0.5) and _G.AutoSpeed == true do
                        for i = 1, 3 do
                            ...
                            game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("kumarion_knit-rojo@0.2.0"):WaitForChild("knit-rojo"):WaitForChild("Services"):WaitForChild("SpeedService"):WaitForChild("RF"):WaitForChild("Purchase"):InvokeServer(unpack(args))
                                        ...
                                        while task.wait(0.5) and _G.AutoRebirth == true do
                                            for i = 1, 3 do
                                                game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("kumarion_knit-rojo@0.2.0"):WaitForChild("knit-rojo"):WaitForChild("Services"):WaitForChild("RebirthService"):WaitForChild("RF"):WaitForChild("Rebirth"):InvokeServer()
                                        ...
                                        while task.wait(1.5) and _G.AutoBestPet == true do
                                            for i = 1, 3 do
                                                ...
                                                game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("kumarion_knit-rojo@0.2.0"):WaitForChild("knit-rojo"):WaitForChild("Services"):WaitForChild("PetService"):WaitForChild("RF"):WaitForChild("Pet"):InvokeServer(unpack(args))
                                        ...
                                        while task.wait(0.5) and _G.AutoEarthEgg == true do
                                            for i = 1, 3 do
                                                ...
                                                game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("kumarion_knit-rojo@0.2.0"):WaitForChild("knit-rojo"):WaitForChild("Services"):WaitForChild("EggService"):WaitForChild("RF"):WaitForChild("Egg"):InvokeServer(unpack(args))
...
local Section = Page.Section("Local Player Information")
                Section.Component("Card", "LocalPlayer DisplayName:", game:GetService("Players").LocalPlayer.DisplayName)
                        ...
                        local Dropdown = Section.Component("Dropdown","Walk Type",{"CFrame","Humanoid"},false,function(SelectedSpeed,bool)
                                ...
                                while task.wait() and _G.LoopWs == true do
                                    if SelectedSpeedOption == "CFrame" then
                                        ...
                                        if game.Players.LocalPlayer.Character and hum and hum.Parent then
                                            hum = game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid")
                                        
                                            if hum.MoveDirection.Magnitude > 0 then
                                                game.Players.LocalPlayer.Character:TranslateBy(hum.MoveDirection * tonumber(awalkspeed) * game:GetService("RunService").Heartbeat:Wait() * 10)
                                            else
                                                game.Players.LocalPlayer.Character:TranslateBy(hum.MoveDirection * game:GetService("RunService").Heartbeat:Wait() * 10)
                                            end
                                        end      
...
Section.Component("Toggle","Enable Animation Speed",function(bool)
    ...
    while task.wait(animspeedup) and _G.AutoAnimsSpeed == true and game:GetService("Players").LocalPlayer.Character and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")  do
...
local AutoHoldTime = 8
                                     ...
                                     Section.Component("Button","CMDX",function()
                                        loadstring(game:HttpGet("https://raw.githubusercontent.com/CMD-X/CMD-X/master/Source",true))()
                                                                            ...
                                                                            local TeleportPlayerType = "MoveTo"
                                                                             Section.Component("Dropdown","Player Teleport Type",{"MoveTo","CFrame","PivotTo"},false,function(TeleportType,bool)
 ...
 Section.Component("Button","Teleport to Safe Area",function()
    ...
    elseif TeleportPlayerType == "PivotTo" then
        game.Players.LocalPlayer.Character:PivotTo(-55282.639679, 573.8871727, 55107.760048, 1, 0, 0, 0, 1, 0, 0, 0, 1)
    end
end
                                            end)    
